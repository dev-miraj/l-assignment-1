...
//             <div key={index} className={`flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white ${plan.recommended ? 'relative' : ''}`}>
//               {plan.recommended && (
//                 <div className="absolute top-0 right-0 px-3 py-1 text-sm text-white bg-purple-600 rounded-tr-lg rounded-bl-lg">
//                   Recommended
//                 </div>
//               )}
...
//               </div>
//               <p className="mb-8 text-gray-500 dark:text-gray-400">{plan.description}</p>
